...
RESILIENCE_LEVEL_EXPLANATIONS = {
    "low": (
        "Фактор виглядає як зона підвищеної потреби в підтримці. "
        "За відповідями педагога відповідна опора або навичка проявляється рідко чи нестабільно."
    ),
    "medium": (
        "Фактор проявляється частково: у дитини вже є певні ресурси, але вони можуть бути нестійкими "
        "або залежати від ситуації."
    ),
    "high": (
        "Фактор виглядає як сильна сторона або наявний ресурс. "
        "Це не означає, що труднощів немає, але цю сферу можна використовувати для підтримки інших зон."
    ),
}


RESILIENCE_PROFILE_NOTE = (
    "Рівні є скринінговою оцінкою на основі відповідей педагога, а не клінічним висновком. "
    "Вони допомагають швидко побачити можливі сильні сторони та зони підтримки."
)


SCORE_CHOICES = [
    ("", "---------"),
    ("5", "5 - повністю відповідає"),
    ("4", "4 - частково відповідає"),
    ("3", "3 - важко сказати"),
    ("2", "2 - частково не відповідає"),
    ("1", "1 - повністю не відповідає"),
...
FACTORS = OrderedDict(
    {
        "family_support": {
            ...
            "items": [
                ...
                {
                    "id": 18,
                    "text": "У дитини гарні стосунки з батьками",
                },
                {
                    "id": 23,
        ...
        "goal_directedness": {
            ...
            "items": [
                {
                    "id": 2,
                    "text": "Дивиться як інші долають труднощі і вчиться у них",
                },
                {
                    "id": 8,
        ...
        "social_connections": {
            ...
            "items": [
                {
                    "id": 7,
                    "text": "Легко знайомиться з новими людьми",
                },
                {
                    "id": 9,
        ...
        "health": {
            ...
            "items": [
                ...
                {
                    "id": 17,
                    "text": "Часто грає в рухливі ігри",
                },
                {
                    "id": 22,
